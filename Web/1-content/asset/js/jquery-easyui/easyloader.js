...
(function () {
    var modules = {
        ...
        uc_draggable: {
            js: 'jquery.uc_draggable.js'
        },
        uc_droppable: {
            js: 'jquery.uc_droppable.js'
        },
        uc_resizable: {
            js: 'jquery.uc_resizable.js'
        },
        uc_linkbutton: {
            js: 'jquery.uc_linkbutton.js',
            css: 'linkbutton.css'
        },
        uc_progressbar: {
            js: 'jquery.uc_progressbar.js',
            css: 'progressbar.css'
        },
        uc_tooltip: {
            js: 'jquery.uc_tooltip.js',
            css: 'tooltip.css'
        },
        uc_pagination: {
            js: 'jquery.uc_pagination.js',
            css: 'pagination.css',
            dependencies: ['linkbutton']
        },
        uc_datagrid: {
            js: 'jquery.uc_datagrid.js',
            css: 'datagrid.css',
            dependencies: ['panel', 'resizable', 'linkbutton', 'pagination']
        },
        uc_treegrid: {
            js: 'jquery.uc_treegrid.js',
            css: 'tree.css',
            dependencies: ['datagrid']
        },
        uc_propertygrid: {
            js: 'jquery.uc_propertygrid.js',
            css: 'propertygrid.css',
            dependencies: ['datagrid']
        },
        uc_panel: {
            js: 'jquery.uc_panel.js',
            css: 'panel.css'
        },
        uc_window: {
            js: 'jquery.uc_window.js',
            css: 'window.css',
            dependencies: ['resizable', 'draggable', 'panel']
        },
        uc_dialog: {
            js: 'jquery.uc_dialog.js',
            css: 'dialog.css',
            dependencies: ['linkbutton', 'window']
        },
        uc_messager: {
            js: 'jquery.uc_messager.js',
            css: 'messager.css',
            dependencies: ['linkbutton', 'window', 'progressbar']
        },
        uc_layout: {
            js: 'jquery.uc_layout.js',
            css: 'layout.css',
            dependencies: ['resizable', 'panel']
        },
        uc_form: {
            js: 'jquery.uc_form.js'
        },
        uc_menu: {
            js: 'jquery.uc_menu.js',
            css: 'menu.css'
        },
        uc_tabs: {
            js: 'jquery.uc_tabs.js',
            css: 'tabs.css',
            dependencies: ['panel', 'linkbutton']
        },
        uc_splitbutton: {
            js: 'jquery.uc_splitbutton.js',
            css: 'splitbutton.css',
            dependencies: ['linkbutton', 'menu']
        },
        uc_menubutton: {
            js: 'jquery.uc_menubutton.js',
            css: 'menubutton.css',
            dependencies: ['linkbutton', 'menu']
        },
        uc_accordion: {
            js: 'jquery.uc_accordion.js',
            css: 'accordion.css',
            dependencies: ['panel']
        },
        uc_calendar: {
            js: 'jquery.uc_calendar.js',
            css: 'calendar.css'
        },
        uc_combo: {
            js: 'jquery.uc_combo.js',
            css: 'combo.css',
            dependencies: ['panel', 'validatebox']
        },
        uc_combobox: {
            js: 'jquery.uc_combobox.js',
            css: 'combobox.css',
            dependencies: ['combo']
        },
        uc_combotree: {
            js: 'jquery.uc_combotree.js',
            dependencies: ['combo', 'tree']
        },
        uc_combogrid: {
            js: 'jquery.uc_combogrid.js',
            dependencies: ['combo', 'datagrid']
        },
        uc_validatebox: {
            js: 'jquery.uc_validatebox.js',
            css: 'validatebox.css',
            dependencies: ['tooltip']
        },
        uc_numberbox: {
            js: 'jquery.uc_numberbox.js',
            dependencies: ['validatebox']
        },
        uc_searchbox: {
            js: 'jquery.uc_searchbox.js',
            css: 'searchbox.css',
            dependencies: ['menubutton']
        },
        uc_spinner: {
            js: 'jquery.uc_spinner.js',
            css: 'spinner.css',
            dependencies: ['validatebox']
        },
        uc_numberspinner: {
            js: 'jquery.uc_numberspinner.js',
            dependencies: ['spinner', 'numberbox']
        },
        uc_timespinner: {
            js: 'jquery.uc_timespinner.js',
            dependencies: ['spinner']
        },
        uc_tree: {
            js: 'jquery.uc_tree.js',
            css: 'tree.css',
            dependencies: ['draggable', 'droppable']
        },
        uc_datebox: {
            js: 'jquery.uc_datebox.js',
            css: 'datebox.css',
            dependencies: ['calendar', 'combo']
        },
        uc_datetimebox: {
            js: 'jquery.uc_datetimebox.js',
            dependencies: ['datebox', 'timespinner']
        },
        uc_slider: {
            js: 'jquery.uc_slider.js',
            dependencies: ['draggable']
        },
        uc_parser: {
            js: 'jquery.uc_parser.js'
        },
        uc_combobox_m: {
            js: 'jquery.uc_combobox_m.js'
        },
        uc_dollar: {
            js: 'jquery.uc_dollar.js'
        },
        uc_dateRange: {
            js: 'jquery.uc_dateRange.js'
        }
    };
    ...
    function loadSingle(name, callback) {
        ...
        if (/^http/i.test(module['js'])) {
            ...
            if (module['js'].indexOf('uc_') >= 0)
                var url = easyloader.base + 'uc_plugins/' + module['js'];
            else
